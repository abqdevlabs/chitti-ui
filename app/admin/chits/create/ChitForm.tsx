      ...
      <Card className="w-full max-w-xl h-auto mx-auto flex flex-col justify-between">
        ...
        {currentStep === 1 && (
          <div>
            <CardHeader>
              <CardTitle>
                {t("chitRegistration.sections.basic.title")}
              </CardTitle>
              <CardDescription>
                {t("chitRegistration.sections.basic.description")}
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <FieldGroup className="grid grid-cols-2 gap-4 max-w-md">
                    ...
                    <Field>
                      <FieldLabel htmlFor="commission">
                        {t("chitRegistration.fields.commission")}
                      </FieldLabel>
                      <Input
                        id="commission"
                        placeholder="10%"
                    ...
                    <Field>
                      <FieldLabel htmlFor="startMonth">
                        {t("chitRegistration.fields.startmonth")}
                      </FieldLabel>
                      <MonthSelect
                        months={MONTH_LIST}
                    ...
                    <Field>
                      <FieldLabel htmlFor="startYear">
                        {t("chitRegistration.fields.startYear")}
                      </FieldLabel>
                      <Input
                        id="startYear"
                        placeholder="2015"
        ...
        {currentStep === 2 && (
          <div>
            <CardHeader>
              <CardTitle>{t2("memberRegistration.create.title")}</CardTitle>
              <CardAction>
              ...
              <CardDescription>
                {t2("memberRegistration.create.description")}
              </CardDescription>
            </CardHeader>
        ...
        <CardFooter className="flex flex-col gap-2 pt-4">
          {currentStep === 1 && (
            <Button
              ...
              disabled={
                chit.name == "" ||
                [chit.commission, chit.duration, chit.monthly, chit.total].some(
                  (value) => !value,
                )
              }
              className="w-full"
